...
function allSourceConfigs() {
  ...
  return [
    ...
    { key: "ygpa_arrival", label: "YGPA arrival", url: env("YGPA_ARRIVAL_API_URL"), serviceKey: env("YGPA_ARRIVAL_API_KEY") || env("YGPA_SERVICE_KEY") },
    { key: "ygpa_departure", label: "YGPA departure", url: env("YGPA_DEPARTURE_API_URL"), serviceKey: env("YGPA_DEPARTURE_API_KEY") || env("YGPA_SERVICE_KEY") },
    { key: "ygpa_vts", label: "YGPA VTS", url: env("YGPA_VTS_API_URL"), serviceKey: env("YGPA_VTS_API_KEY") || env("YGPA_SERVICE_KEY") },
